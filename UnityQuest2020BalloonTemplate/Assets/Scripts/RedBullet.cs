...
{
    /*red bullet looks different but is the same as blue, issues previous lied with the Red and Blue Portal scripts
     * 
     * 
     * 
     * 
    ...
    private void Start()
    {
        ...
        objectToDestroy = GameObject.FindGameObjectWithTag("RedPortal");
